...
const routes = [
	...
	},
	{
		...
		// 扶贫商品列表路由
	{
		path: '/poverty_alleviation_commodities/list',
		name: '/poverty_alleviation_commodities_list',
		component: () => import('../views/poverty_alleviation_commodities/list.vue')
	},
	
		// 扶贫商品详情路由
	{
		path: '/poverty_alleviation_commodities/details',
		name: '/poverty_alleviation_commodities_details',
		component: () => import('../views/poverty_alleviation_commodities/details.vue')
	},
