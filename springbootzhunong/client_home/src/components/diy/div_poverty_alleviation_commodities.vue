<template>
	<div class="diy_details_box diy_div_poverty_alleviation_commodities">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/poverty_alleviation_commodities/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/poverty_alleviation_commodities/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var poverty_alleviation_commodities_id = this.obj.poverty_alleviation_commodities_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "poverty_alleviation_commodities",
          source_field: "poverty_alleviation_commodities_id",
          source_id: poverty_alleviation_commodities_id
        }, (res) => {
