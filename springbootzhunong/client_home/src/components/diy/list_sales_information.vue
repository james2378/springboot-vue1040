<template>
	<div class="diy_home diy_list diy_sales_information" id="diy_sales_information_list">
		<!-- 列表 -->
			...
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/sales_information/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						订单日期
							...
							<th class="diy_title" v-if="$check_field('get','sales_month')">
						销售月份
					</th>
				...
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_text" v-if="$check_field('get','sales_month')">
						<span>
							{{ o["sales_month"] }}
						</span>
					</td>
