		...
		<el-form ref="form" :model="form" status-icon label-width="70px">
			...
			<el-col :xs="24" :sm="24" :lg="24" v-show="!form.source_table" style="text-align: center;" class="el_form_btn_warp">
				...
				<el-button @click="cancel()">取消</el-button>
						...
						<!-- 扶贫商品 -->
			<diy_poverty_alleviation_commodities v-if="form.source_table === 'poverty_alleviation_commodities'" :query="{poverty_alleviation_commodities_id:form.source_id}" :form_goods="form" :func_check="checkForm" :func_submit="submit" ></diy_poverty_alleviation_commodities>
...
<script>
	import mixin from "../../mixins/page.js";
				import diy_poverty_alleviation_commodities from "../../components/diy/diy_poverty_alleviation_commodities.vue";
					
	export default {
		mixins: [mixin],
		components:{
						diy_poverty_alleviation_commodities,
							},
		data() {
			return {
				field: "goods_id",
				...
				form: {
					...
					source_id: 0
							...
							"form_poverty_alleviation_commodities": {},
