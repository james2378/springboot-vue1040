			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="店铺名称" prop="store_name">
					...
					<div v-else-if="$check_field('get','store_name')">{{form_sub['store_name']}}</div>
								...
								<el-col v-if="user_group === '管理员' || $check_field('get','store_introduction') || $check_field('add','store_introduction') || $check_field('set','store_introduction')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="店铺简介" prop="store_introduction">
								<el-input type="textarea" id="store_introduction" v-model="form_sub['store_introduction']" placeholder="请输入店铺简介"
						v-if="user_group === '管理员' || (form_sub['seller_id'] && $check_field('set','store_introduction')) || (!form_sub['seller_id'] && $check_field('add','store_introduction'))"></el-input>
					<div v-else-if="$check_field('get','store_introduction')">{{form_sub['store_introduction']}}</div>
							</el-form-item>
			</el-col>
			...
			return {
				...
				disabledObj:{
								"store_name_isDisabled": false,
										"store_introduction_isDisabled": false,
							},
