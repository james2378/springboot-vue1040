...
/**
 * 扶贫商品：(PovertyAlleviationCommodities)表实体类
 *
 */
@Setter
@Getter
@Entity(name = "PovertyAlleviationCommodities")
public class PovertyAlleviationCommodities implements Serializable {

    // PovertyAlleviationCommodities编号
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "poverty_alleviation_commodities_id")
    private Integer poverty_alleviation_commodities_id;
